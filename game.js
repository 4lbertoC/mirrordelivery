...
Map = '0000000000000000000000000000000000000000' +
	...
	'0020111100111110011121111001111112111111' +
	'0020000000000000000020000000000002000000' +
	'0020000000000000000020000000000002000000' +
	'0000000000000000000011110000200002000000' +
	'0000000000000000000000000000211112000000' +
	'0000000000000000000000000000200000000000' +
	'1111111111111111111111111111111111111111' +
	'1111111111111111111111111111111111111111'.split('');
// for (i = 920; i < 960; i++) {
...
// Map[524] = BLOCK_TYPE.SOLID;
// Map[525] = BLOCK_TYPE.SOLID;
// Map[526] = BLOCK_TYPE.SOLID;
// Map[527] = BLOCK_TYPE.SOLID;
// Map[528] = BLOCK_TYPE.SOLID;
// Map[523] = BLOCK_TYPE.LADDER;
// Map[563] = BLOCK_TYPE.LADDER;
// Map[603] = BLOCK_TYPE.LADDER;
// Map[643] = BLOCK_TYPE.LADDER;
// Map[683] = BLOCK_TYPE.LADDER;
// Map[723] = BLOCK_TYPE.LADDER;
// Map[763] = BLOCK_TYPE.LADDER;
...
function processInput(t) {
	...
	var speed = Player.speed,
		...
		k = KeyHandler.k;
	if (k[37]) { // LEFT
		Player.position[0] = Math.max(BLOCK_SIZE, x - (Player.isJumping ? Player.horizontalJumpSpeed : speed));
	...
	if (k[39]) { // RIGHT
		Player.position[0] = Math.min(CANVAS_WIDTH - 2 * BLOCK_SIZE, x + (Player.isJumping ? Player.horizontalJumpSpeed : speed));
		Player.isMoving = true;
	}

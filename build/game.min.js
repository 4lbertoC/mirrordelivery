...
document.getElementById(c);l(b,Ua,function(c){c.preventDefault();la.La({keyCode:a})});l(b,fb,function(c){c.preventDefault();la.Ma({keyCode:a})})}function ea(c,a,b,d){var e=Object.create(Bb);e.position=a;e.text=[c];e.color=b;e.time=va+Cb;e.Ia=d||!1;Ma.push(e)}function za(c,a,b,d,e){var f=Object.create(Db);f.position=c.slice();f.d=a.slice();f.color=b;f.time=va+Eb;f.size=d;f.speed=e;Da.push(f)}function U(c){var a=c[t.ca],b,d,e,f;Va.T=a;for(var h=R.length=0;h<c[t.h].length;h++)b=c[t.h][h],d=Object.create(Va),
d.size=b,e=document.createElement("canvas"),e.width=Ia+b,e.height=Ia+b,f=e.getContext("2d"),f.fillStyle="#ea0",f.strokeStyle="#330",f.fillRect(0,0,Ia+b,Ia+b),f.strokeRect(0,0,Ia+b,Ia+b),f.fillStyle="#000",f.fillText(b,5,10),d.ma=e,e=a[0]+16*h,b=a[1]-b,d.position=[e,b],d.T=[e,b],R.push(d)}function E(c){c=f.o=B[c]||B[w];a.position=c[t.ha].slice();a.u=0;a.v=0;a.oa=0;a.c=void 0;a.Z=rb;a.w=!1;a.G=!1;a.r=!1;a.e=!1;a.j=!1;d.$=sb;d.i=0;d.A=0;d.position=c[t.U].slice();d.d=c[t.U].slice();b=c[t.L].slice();y=
[c[t.L][0]+15,c[t.L][1]+23];p=y.slice();q=1;C.position=C.d=null;C.na=gb;f.time=0;oa(x.k);T=0;Ea.length=0;wa.length=0;Ma.length=0;Da.length=0;ia="4444444444444444444444444444444444444444"+c[t.ga]+"4444444444444444444444444444444444444444";ia=ia.split("");Ja=null;U(c);Wa=ba.slice();window.localStorage&&(window.localStorage.Aa=JSON.stringify(B));M()}function M(){var c,a;for(c=0;c<Q;c++)for(a=0;a<ha;a++)Ca(Fb,ia[Q*a+c],c*A,a*A)}function oa(c){f.state=c;if(S){var a=document.getElementsByClassName("e");
c="b e"+(c===x.f?"":" h");for(var b=0;b<a.length;b++)a[b].setAttribute("class",c)}}function pa(c){oa(x.l);f.time=va+f.o[t.n];ta&&(Xa=c+Ra);m()}function V(c){f.ka+=1;m(!0);K(v.Ea);Ya=!0;E(w);Za=c+Sa}function Oa(c){f.la+=1;m(!0);K(v.wa);Ya=!1;E(w);Za=c+Sa}function fa(c,a){return Math.atan((a[1]-c[1])/(a[0]-c[0]))}function H(c,a){return c&&a&&Math.sqrt(Math.pow(c[0]-a[0],2)+Math.pow(c[1]-a[1],2))}function Y(a,b){return ia[Q*Math.floor(b/A)+Math.floor(a/A)]}function Z(a,b,d,e,f){var h=b,m=Y(a,h);d=a+
d;topRight=Y(d,h);bottomRight=Y(d,b+e);bottomLeft=Y(a,b);return m===f||topRight===f||bottomRight===f||bottomLeft===f}function ja(a,b,d,e,f){b+=e;e=Y(a,b);bottomLeft=Y(a+d,b);return e===f||bottomLeft===f}function Pa(){var c=a.v,b=qa();if(a.e)c=a.v;else if(a.r)c=Math.min(b,c+b/25);else if(c*=Math.min(0.2*b,0.8),0.2>c||ga(J.q))c=0;a.v=c;return ga(J.q)?b/2:c}function qa(){return Math.max(1,a.speed+a.S-(void 0!==a.c?R[a.c].size:0))}function ga(c){return Z(a.position[0]-8,a.position[1]-32,16,32,c)||Z(a.position[0],
...
x.f)if(T<Fa){var c=Q*Math.floor(u[1]/A)+Math.floor(u[0]/A);c<ia.length-Q&&c>Q&&(ia[c]=""+T);M()}else if(T===xa.Ba)a.position=u.slice();else if(T===xa.B)d.position=u.slice();else if(T===xa.K)b=u.slice(),y=[b[0]+15,b[1]+23],p=y.slice();else{if(T===xa.h)for(Va.T=u.slice(),c=0;c<R.length;c++){var e=R[c];e.position[0]=u[0]+16*c;e.position[1]=u[1]-e.size}}else f.state!==x.k||S?0<d.i&&d.A<va&&(d.i--,K(v.ua),c=Object.create(Ib),c.position=d.position.slice(),wa.push(c)):u[0]>d.position[0]-16&&(u[0]<d.position[0]+
...
2,P/2-50),F(O,["Luke "+f.ka],N/2-50,P/2,!0===Ya?"#0f0":"#fff","right"),F(O,[f.la+" Crow"],N/2+50,P/2,!1===Ya?"#0f0":"#fff","left"),O.font="15px courier",O.fillText("A 13kB game by Alberto Congiu",N/2,12),Za<c&&(O.fillText("Click the "+(S?"screen":"crow")+" to start",N/2,P/2+60),O.fillText("< >: Select level",N/2,P/2+100),O.fillText(g[t.V]?"E: EDIT   "+(S?"S":"D")+": DELETE   "+(S?"A":"J")+": EXPORT   I: IMPORT":"E: EDIT   I: IMPORT",N/2,P/2+120)),O.beginPath(),O.arc(d.position[0],d.position[1],16,
0,360),O.lineWidth=2,O.strokeStyle="#fff",O.stroke(),n.drawImage(ab,0,0));f.state===x.f&&(n.globalAlpha=0.6,T<Fa?(Ca(n,""+T,u[0]-u[0]%A,u[1]-u[1]%A),n.strokeStyle="#000",n.strokeRect(u[0]-u[0]%A,u[1]-u[1]%A,A,A)):T===xa.Ba?e(G.t,u[0]-8,u[1]-24,1):T===xa.B?e(G.B,u[0]-8,u[1]-8,0):T===xa.K?D(n,G.K,u[0],u[1]):T===xa.h&&(n.fillStyle="#ea0",n.strokeStyle="#330",n.fillRect(u[0]-8,u[1]-8,16,16),n.strokeRect(u[0]-8,u[1]-8,16,16),n.fillStyle="#000",n.fillText("C",u[0]-4,u[1]+4)),n.globalAlpha=1);window.requestAnimationFrame(sa)}
...
window[b[d]+"RequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b){var d=(new Date).getTime(),e=Math.max(0,16-(d-a)),f=window.setTimeout(function(){b(d+e)},e);a=d+e;return f})})();var S=!1,Na=document.getElementById("o"),ma=Na.getBoundingClientRect(),ub=[100,100],mb=!1,ya=null,Ua=null,fb=null,yb=null;if("ontouchstart"in document.documentElement||window.navigator.msMaxTouchPoints)for(var S=!0,Ua=window.navigator.msMaxTouchPoints?"MSPointerDown":"touchstart",
...
-1,-1,0,0.01,-0.3,-1,-1,0,0,-1,0,0.0040,0,1,1,0,0,-1]);window.addEventListener("keyup",la.Ma,!1);window.addEventListener("keydown",la.La,!1);if(S){l(da,Ua,function(a){a.preventDefault();f.state===x.k&&pa()});L("x",h.k);L("e",h.I);L("l",h.W);L("u",h.ja);L("r",h.X);L("d",h.va);L("i",h.N);L("s",h.H);L("a",h.J);L("c",h.h);L("t",h.n);L("n",h.m);var Ab=function(a){a.preventDefault();ya=a.changedTouches||a;ma=Na.getBoundingClientRect();mb=!0};l(Na,Ua,Ab);l(Na,yb,Ab);l(Na,fb,function(a){a.preventDefault();

...
mkdir $BUILDFOLDER
echo "Compiling..."
java -jar compiler.jar --js scripts/base64.js --js scripts/jsfx/audio.js --js scripts/jsfx/jsfx.js --js scripts/jsfx/jsfxlib.js --js scripts/game.js --compilation_level ADVANCED_OPTIMIZATIONS --externs scripts/jsfx/externs.js > $BUILDFOLDER/game.min.js
